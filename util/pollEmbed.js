...
const pollEmbed = async (msg, title, options, timeout = 12, emojiList = defEmojiList.slice(), forceEndPollEmoji = '\u2705') => {
	...
	const poll = await msg.channel.send({ embeds: [embedBuilder(title, msg.author.username).setDescription(text)] });
