...
module.exports = {
  ...
  async execute(message, args, client, guildDB) {
    ...
    try {
      ...
      const userbe = new discord.MessageEmbed().setColor('#b434eb');
      ...
      userbe
        .addField(
          lang.d,
          new Intl.NumberFormat().format(parseFloat(user.stats.followerCount)),
          true
        )
        .addField(
          lang.e,
          new Intl.NumberFormat().format(parseInt(user.stats.followingCount)),
          true
        )
        .addField(
          lang.f,
          new Intl.NumberFormat().format(parseInt(user.stats.heartCount))
        )
        .setFooter(
