module.exports = {
  ...
  links: {
    ...
    invite:
      'https://discord.com/oauth2/authorize?client_id=783708073390112830&scope=bot&permissions=8',
  ...
  ticket: {
    api_url_create:
      'https://info-api.dev.nccsoft.vn/api/services/app/KomuJobService/CreateJob',
    api_url_get:
  ...
  submitTimesheet: {
    api_url_getListUserLogTimesheet:
      'http://timesheetapi.nccsoft.vn/api/services/app/Public/GetListUserLogTimesheetThisWeekNotOk',
  },
  wiki: {
    api_url:
      'http://project-api.nccsoft.vn/api/services/app/User/GetEmployeeInformation?email=',
